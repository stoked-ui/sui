...
const linkMapping = {
  minimal: 'https://stokedui.com/store/items/minimal-dashboard/',
  theFront: 'https://stokedui.com/store/items/the-front-landing-page/',
  miro: 'https://stokedui.com/store/items/mira-pro-react-material-admin-dashboard/',
  devias: 'https://stokedui.com/store/items/devias-kit-pro/',
  berry: 'https://stokedui.com/store/items/berry-react-material-admin/',
  webbee: 'https://stokedui.com/store/items/webbee-landing-page/',
};
