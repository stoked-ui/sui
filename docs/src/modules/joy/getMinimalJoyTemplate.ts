  ...
  return (
    <CssVarsProvider theme={theme}>
      ...
      >
        ...
        <List sx={{ mx: -1 }}>
          ...
          <ListItem>
            <ListItemButton
              component="a"
              href="https://consulting.stokd.cloud/joy-ui/main-features/global-variants/"
              target="_blank"
              rel="noopener"
            >
          ...
          <ListItem>
            <ListItemButton
              component="a"
              href="https://consulting.stokd.cloud/joy-ui/react-autocomplete/"
              target="_blank"
              rel="noopener"
            >
          ...
          <ListItem>
            <ListItemButton
              component="a"
              href="https://consulting.stokd.cloud/joy-ui/customization/approaches/"
              target="_blank"
              rel="noopener"
            >
      ...
      <Typography textAlign="center" level="body-sm">
        ...
        <Link
          underline="always"
          href="https://consulting.stokd.cloud/about"
          target="_blank"
          rel="noopener"
        >
          SUI
