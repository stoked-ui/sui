...
if (process.env.CONTEXT === 'production' || process.env.CONTEXT === 'branch-deploy' || process.env.SST_STAGE === 'production' || process.env.NODE_ENV === 'production') {
...
function withDocsInfra(nextConfig) {
  ...
  return {
    ...
    env: {
      ...
      ENABLE_AD_IN_DEV_MODE: process.env.ENABLE_AD_IN_DEV_MODE || 'false',
