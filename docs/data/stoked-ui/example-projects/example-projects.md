...
{{"component": "MaterialUIExampleCollection"}}
...
For more complex prebuilt UIs, check out our [premium themes and templates](https://stokedconsulting.com/store/?utm_source=docs&utm_medium=referral&utm_campaign=example-projects-store) in the SUI Store.
