...
describe('<Button />', () => {
  ...
  it("should disable ripple when SuiButtonBase has disableRipple in theme's defaultProps", () => {
  ...
  it("should disable ripple when SuiButtonBase has disableRipple in theme's defaultProps but override on the individual Buttons if provided", () => {
    const theme = createTheme({
      components: {
        SuiButtonBase: {
          defaultProps: {
