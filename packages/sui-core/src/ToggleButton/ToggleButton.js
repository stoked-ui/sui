...
import ToggleButtonGroupContext from '@mui/material/ToggleButtonGroup/ToggleButtonGroupContext';
import ToggleButtonGroupButtonContext from '@mui/material/ToggleButtonGroup/ToggleButtonGroupButtonContext';
import isValueSelected from '@mui/material/ToggleButtonGroup/isValueSelected';
  ...
  return {
    ...
    '&:hover': {
      ...
      backgroundColor: theme.vars
        ? `rgba(${theme.vars.palette.background.default} / ${theme.vars.palette.action.hoverOpacity})`
        : alpha(theme.palette.background.default, theme.palette.action.hoverOpacity),
      '@media (hover: none)': {
