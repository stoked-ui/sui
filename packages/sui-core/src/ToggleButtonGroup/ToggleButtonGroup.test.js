...
describe('<ToggleButtonGroup />', () => {
  ...
  it('can render group orientation vertically', () => {
    ...
    expect(getByRole('group')).to.have.class('SuiToggleButtonGroup-vertical');
    expect(getByRole('button')).to.have.class('SuiToggleButtonGroup-groupedVertical');
  });
