...
import toggleButtonGroupClasses, {
  getToggleButtonGroupUtilityClass, ToggleButtonGroupClasses,
...
})(({ ownerState, theme }: { ownerState: any, theme: Theme }) => ({
  display: 'inline-flex',
...
const ToggleButtonGroup = React.forwardRef(function ToggleButtonGroup(inProps: any, ref) {
  const props = useThemeProps({ props: inProps, name: 'SuiToggleButtonGroup' });
  const {
    children,
    className,
    color = 'standard',
