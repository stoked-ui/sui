/**
 * @packageDocumentation Named Id Generator
 *
 * This package provides a function for generating unique named IDs with optional prefix and suffix.
 */
