 ...
 * Grok Loader Component
 *
 * A motion-enabled container with consistent styling, featuring a rotating triangle of dots.
 */
...
/**
 * @typedef { import('@mui/material/styles').StyledComponent } StyledComponent
 */

/**
 * A motion-enabled container with consistent styling.
 */
...
/**
 * A dot component for consistent styling.
 */
