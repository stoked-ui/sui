          ...
          root: ({ theme, ownerState }) => ({
            ...
            ...(ownerState.variant === 'outlined' &&
              ownerState.color === 'secondary' && {
                ...
                borderColor: theme.palette.primaryDark[100],
                ...
                ...theme.applyDarkStyles({
                  ...
                  boxShadow: `${alpha(theme.palette.primaryDark[600], 0.2)} 0 2px 0 inset, ${theme.palette.common.black} 0 -2px 0 inset, ${theme.palette.common.black} 0 1px 2px 0`,
                  '&:hover': {
            ...
            ...(ownerState.variant === 'outlined' &&
              ownerState.color === 'primary' && {
                ...
                ...theme.applyDarkStyles({
                  ...
                  boxShadow: `${alpha(theme.palette.primary[900], 0.2)} 0 2px 0 inset, ${theme.palette.common.black} 0 -2px 0 inset, ${theme.palette.common.black} 0 1px 2px 0`,
                  '&:hover': {
          ...
          root: ({ theme, ownerState }) => [
            {
              ...
              ...(ownerState.variant === 'outlined' && {
                ...
                '&[href]': {
                  ...
                  '&:hover': {
                    borderColor: theme.palette.primary[200],
                    boxShadow: `0px 2px 8px ${theme.palette.primary[100]}`,
                  },
                  '&:focus-visible': {
                    outline: `3px solid ${alpha(theme.palette.primary[500], 0.5)}`,
                    outlineOffset: '2px',
                ...
                ':is(a&), :is(button&)': {
                  '&:hover': {
                    borderColor: theme.palette.primary[200],
                    boxShadow: `0px 4px 16px ${theme.palette.grey[200]}`,
                  },
                },
              }),
            },
            theme.applyDarkStyles({
              ...
              ...(ownerState.variant === 'outlined' && {
                ...
                '&[href]': {
                  textDecorationLine: 'none',
                  boxShadow: `${alpha(theme.palette.primaryDark[700], 0.4)} 0 2px 0 inset, ${theme.palette.common.black} 0 -2px 0 inset, ${theme.palette.common.black} 0 1px 2px 0`,
                  '&:hover': {
                ...
                ':is(a&), :is(button&)': {
                  '&:hover': {
                    boxShadow: `0px 4px 24px ${theme.palette.common.black}`,
                  },
                },
              }),
            }),
      ...
      MuiCssBaseline: {
        ...
        styleOverrides: {
          html: {
            ...
            // https://github.com/stoked-ui/stoked-ui/issues/40748
