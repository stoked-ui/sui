...
import SvgHamburgerMenu from "../icon/SvgHamburgerMenu";
import LogoWithCopyMenu from '../action/LogoWithCopyMenu';
...
function AppFrame(props: any): React.ReactElement {
