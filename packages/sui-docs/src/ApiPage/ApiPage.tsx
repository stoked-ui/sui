...
import PropertiesSection, {
  getPropsToC,
} from './sections/PropertiesSection';
import ClassesSection, {
  getClassesToC,
} from './sections/ClassesSection';
import SlotsSection from './sections/SlotsSection';
import { DEFAULT_API_LAYOUT_STORAGE_KEYS } from './sections/ToggleDisplayOption';
...
export default function ApiPage(props) {
  ...
  const {
    ...
    componentDescriptionToc = new Array(),
    classDescriptions,
    propDescriptions,
    slotDescriptions,
