...
export function CodeStylingProvider(props) {
  ...
  const contextValue = React.useMemo<{ codeStyling: any, noSsrCodeStyling: any, setCodeStyling: any }>(() => {
