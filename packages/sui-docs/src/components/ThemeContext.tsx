...
function resolvePaletteMode(mode: string | null) {
...
function getInitialThemeOptions(initialMode: 'light' | 'dark' | 'system' = 'system') {
...
export function ThemeProvider(props: any) {
  ...
  const theme = React.useMemo(() => {
    ...
    let nextTheme: any = createMdTheme(
      ({
        direction,
      ...
      languageMap[userLanguage as keyof typeof languageMap],
    );
