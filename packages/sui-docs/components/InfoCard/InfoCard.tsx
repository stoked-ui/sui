...
import {Link, LinkProps} from '../../components/../components/../components/Link.js';
...
export function InfoCard(props: InfoCardProps) {
  ...
  return (
    <Paper
      ...
      {...other}
    >
      <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center', marginBottom: description ? 8 : 0}}>
        {svg && svg}
