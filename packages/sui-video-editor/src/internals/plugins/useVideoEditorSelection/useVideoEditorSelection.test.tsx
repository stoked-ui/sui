...
import { describeVideoEditor } from 'test/utils/fileExplorer-view/describeVideoEditor';
import {
  UseVideoEditorExpansionSignature,
 ...
 * are located in the `useVideoEditorKeyboardNavigation.test.tsx` file.
 */
describeVideoEditor<[UseVideoEditorSelectionSignature, UseVideoEditorExpansionSignature]>(
  'useVideoEditorSelection plugin',
  ({ render }) => {
    describe('model props (selectedItems, defaultSelectedItems, onSelectedItemsChange)', () => {
      ...
      it('should warn when switching from controlled to uncontrolled', () => {
        ...
        expect(() => {
          ...
          'SUI X: A component is changing the controlled selectedItems state of VideoEditor to be uncontrolled.',
        );
      });
      ...
      it('should warn and not react to update when updating the default state', () => {
        ...
        expect(() => {
          ...
          'SUI X: A component is changing the default selectedItems state of an uncontrolled VideoEditor after being initialized. To suppress this warning opt to use a controlled VideoEditor.',
        );
      });
    });
    ...
    describe('item click interaction', () => {
      ...
      describe('multi selection', () => {
        ...
        it('should do nothing when clicking on an item content on a fresh fileExplorer whil holding Shift', () => {
          const response = render({
            multiSelect: true,
        ...
        it('should not crash when selecting multiple items in a deeply nested fileExplorer', () => {
          const response = render({
            multiSelect: true,
            items: [
    ...
    describe('aria-multiselectable fileExplorer attribute', () => {
