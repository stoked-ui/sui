/**
 * @interface FeatureSnapIcon
 * @description A feature snap icon component used to display the edge snap functionality.
 */
...
const EdgeSnap = createSvgIcon(
  ...
  <React.Fragment>
    /**
     * @description The path for the icon's first part.
     */
    ...
    /**
     * @description The path for the icon's second part.
     */
...
/**
 * @description Exports the EdgeSnap component.
 */
