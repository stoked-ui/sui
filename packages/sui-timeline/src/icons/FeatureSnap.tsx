/**
 * FeatureSnapIcon component is a custom SVG icon component for feature snap functionality.
 *
 * @param {object} props - The props for the FeatureSnapIcon component
 * @property {string} fillRule - The fill rule for the SVG paths
 * @returns {JSX.Element} React component
 * @example
 * <FeatureSnapIcon fillRule="evenodd" />
 */
