/**
 * SVG icon component for Grid Snap feature.
 * 
 * @param {object} props - The props for the GridSnapIcon component.
 * @property {string} fillRule - The fill rule for the SVG paths.
 * 
 * @returns {JSX.Element} React component representing the Grid Snap icon.
 * 
 * @example
 * <GridSnapIcon fillRule="evenodd" />
 */
