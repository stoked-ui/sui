...
export function checkProps(props) {
    let { editorData = [], effects = {}, scrollTop = 0, scale = DEFAULT_SCALE, scaleSplitCount = DEFAULT_SCALE_SPLIT_COUNT, scaleWidth = DEFAULT_SCALE_WIDTH, startLeft = DEFAULT_START_LEFT, minScaleCount = MIN_SCALE_COUNT, maxScaleCount = Infinity, rowHeight = DEFAULT_ROW_HEIGHT, } = props;
    if (scale <= 0) {
...
//# sourceMappingURL=check_props.js.map