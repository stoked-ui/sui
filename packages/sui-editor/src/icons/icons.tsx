/**
 * Represents an expand icon for a file explorer component.
 */
...
/**
 * Represents a collapse icon for a file explorer component.
 */
...
/**
 * Represents an icon using Lottie animation.
 * @returns {JSX.Element} The Lottie animation icon component.
 */
