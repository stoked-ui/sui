/**
 * Type declarations for @stoked-ui/video-renderer-wasm
 *
 * This module is built from Rust/WASM and may not be available at compile time.
 * The actual types are generated by wasm-bindgen in packages/sui-video-renderer/pkg/wasm_preview.d.ts
 */
