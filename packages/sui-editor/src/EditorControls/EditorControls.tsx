...
const RateControlRoot = styled(FormControl)(({theme}) => ({
  ...
  alignContent: 'center',
  marginRight: '2px',
  '&:hover div.MuiSelect-select.MuiSelect-outlined': {
    ...
    return (
      <PlayerRoot id={'timeline-controls'} className="timeline-player" ref={ref}>
        ...
        <Box sx={(theme) => ({
          display: 'flex',
          flexDirection: 'row',
          '& .MuiFormControl-root.rate-control .MuiInputBase-root svg': {
            color: `${theme.palette.text.primary}!important`,
          },
          '& .MuiFormControl-root.rate-control .MuiInputBase-root fieldset': {
            border: `1px solid ${theme.palette.text.primary}!important`,
          },
          '& .MuiFormControl-root.rate-control .MuiInputBase-root:hover fieldset': {
            border: `2px solid ${theme.palette.primary[500]}!important`,
          }
        })}>
