...
>('useFileExplorerKeyboardNavigation', ({ render, fileExplorerViewComponentName }) => {
  describe('Navigation (focus and expansion)', () => {
    ...
    describe('key: Home', () => {
      it('should move the focus to the first item in the fileExplorer', () => {
        const response = render({
    ...
    describe('key: End', () => {
      it('should move the focus to the last item in the fileExplorer when the last item is not expanded', () => {
        const response = render({
          items: [
            { id: '1' },
            { id: '2' },
      ...
      it('should move the focus to the last item in the fileExplorer when the last item is expanded', () => {
        const response = render({
          items: [
            { id: '1' },
            { id: '2' },
  ...
  describe('Type-ahead', () => {
    ...
    it('should work with ReactElement label', function test() {
      // Only the FileExplorerBasic can have React Element labels.
