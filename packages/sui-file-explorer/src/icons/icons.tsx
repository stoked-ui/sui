/**
 * SVG icon component for expanding file explorer
 * @returns {JSX.Element} React element representing the FileExplorerExpandIcon
 */
...
/**
 * SVG icon component for collapsing file explorer
 * @returns {JSX.Element} React element representing the FileExplorerCollapseIcon
 */
 ...
 * @returns {JSX.Element} React element representing the LottieIcon
 */
