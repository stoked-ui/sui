...
export type ComponentInfo = {
  ...
  filename: string;
  /**
   * Component name as imported in the docs, in the global SUI namespace.
   */
  name: string;
  /**
  ...
  /**
   * If `true`, the component's name match one of the SUI System components.
   */
...
export type HookInfo = {
  ...
  filename: string;
  /**
   * Hook name as imported in the docs, in the global SUI namespace.
   */
  name: string;
  apiPathname: string;
